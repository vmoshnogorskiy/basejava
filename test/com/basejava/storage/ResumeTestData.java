...
public class ResumeTestData {
    ...
    protected static Resume getTestResume(String uuid, String fullName) {
        ...
        experienceList.add(new Organization("Java Online Projects",
                        "http://javaops.ru/",
                        new Organization.Property(LocalDate.of(2013, 10, 1),
                                "Автор проекта.",
        ...
        experienceList.add(new Organization("Wrike",
                        "https://www.wrike.com/",
                        new Organization.Property(LocalDate.of(2014, 10, 1),
        ...
        experienceList.add(new Organization("RIT Center",
                        null,
                        new Organization.Property(LocalDate.of(2012, 4, 1),
        ...
        Organization university = new Organization("Санкт-Петербургский национальный исследовательский университет" +
                ...
                "https://itmo.ru/ru/",
                new Organization.Property(LocalDate.of(1993, 9, 1),
                        LocalDate.of(1996, 7, 1),
                        "Аспирантура (программист С, С++)",
                        null
                ),
                new Organization.Property(LocalDate.of(1987, 9, 1),
        ...
        Organization school = new Organization(
                ...
                new Organization.Property(LocalDate.of(1984, 9, 1),
